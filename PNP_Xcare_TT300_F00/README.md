...
This document describes how to connect TT300-F00 to Azure IoT Hub using the Azure IoT Explorer with certified device application and device models.
...
-   Prepare TT300-F00,and install Win10 IoT Enterprise.
-   Power on the TT300-F00.
-   Connect to the network.

**Software Environmental setup**
-   Download the source code from this GitHub and check the [“PNP_Xcare_TT300_F00”](https://github.com/allanchen1971/AzureCertification/tree/master/PNP_Xcare_TT300_F00) folder
...
Run the sample
Under the “PNP_Xcare_TT300_F00” folder, open the project and set debug parameter: 
...
Please refer to this tutorial to create the [TT300-F00](https://docs.microsoft.com/en-us/azure/iot-central/core/howto-set-up-template#create-a-device-template-from-the-device-catalog) device template.
3.	Add a device
Add a new device under TT300-F00 device template. Make a note of the device ID.
